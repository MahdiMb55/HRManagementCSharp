...
using HRManagement.Infrastructure.Audit;
using HRManagement.Infrastructure.Backups;
...
using HRManagement.Infrastructure.Letters;
...
using HRManagement.Infrastructure.Settings;
...
public static class ServiceRegistration
{
        ...
        ApplicationPaths paths)
    {
        ...
        services.AddScoped<IAdministrationSettingsService, AdministrationSettingsService>();
        services.AddScoped<IAuditLogService, AuditLogService>();
        services.AddScoped<ILetterRepository, EfLetterRepository>();
        services.AddScoped<ILetterService, OpenXmlLetterService>();
        ...
        services.AddTransient<LetterIssuanceControl>();
